...
```
Нивоата ни се претставени како стрингови и содржат информации за името, висина/ширина на полињата, броевите за секој ред/колона, бојата на секое поле во RGB формат и дали е точно или не полето.
```c#
